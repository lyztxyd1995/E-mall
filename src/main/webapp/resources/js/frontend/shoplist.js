$(function() {
	...
	var pageSize = 10;
	// 获取店铺列表的URL
	var listUrl = '/o2omall/frontend/listshops';
	// 获取店铺类别列表以及区域列表的URL
	var searchDivUrl = '/o2omall/frontend/listshopspageinfo';
	// 页码
	var pageNum = 1;
				...
				.getJSON(
						...
						function(data) {
							if (data.success) {
								...
								var html = '';
								html += '<a href="#" class="button" data-category-id=""> All shop categories  </a>';
								// 遍历店铺类别列表，拼接出a标签集
								shopCategoryList
	...
	$('.shop-list').on('click', '.card', function(e) {
		...
		window.location.href = '/o2omall/frontend/shopdetail?shopId=' + shopId;
	});
