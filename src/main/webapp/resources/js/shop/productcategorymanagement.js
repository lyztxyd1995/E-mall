$(function() {
	var listUrl = '/o2omall/shopadmin/getproductcategorylist';
	var addUrl = '/o2omall/shopadmin/addproductcategories';
	var deleteUrl = '/o2omall/shopadmin/removeproductcategory';
	getList();
	function getList() {
		$
				.getJSON(
